...
export default function Login() {
  ...
  const [name, setName] = useState(
    () => localStorage.getItem('remember_me_username') || ''
  )
    ...
    const run = async () => {
      try {
        ...
        void sendLog({
          ...
          source: 'Auth',
          meta: { username, role, time: new Date().toISOString() },
        })
        const go = (() => {
            ...
            <div className="border-b border-gray-200 pb-1 flex items-center gap-2">
              ...
              >
                <path
                  ...
                  d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.5 20.25a8.25 8.25 0 1 1 16.5 0v.75H4.5v-.75Z"
                />
              </svg>
              <input
                value={name}
            ...
            <div className="border-b border-gray-200 pb-1 flex items-center gap-2">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0V10.5m-.75 11.25h10.5A2.25 2.25 0 0 0 19.5 19.5v-6.75A2.25 2.25 0 0 0 17.25 10.5H6.75A2.25 2.25 0 0 0 4.5 12.75V19.5a2.25 2.25 0 0 0 2.25 2.25Z"
                />
              </svg>
              <input
                type="password"
