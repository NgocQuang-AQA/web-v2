      ...
      <div className="ml-2 pl-2 border-l border-gray-200">
        <div className="hs-dropdown relative inline-flex" ref={dropdownRef}>
          <button
            ...
            type="button"
            className="hs-dropdown-toggle btn btn-secondary"
            aria-haspopup="menu"
          ...
          <div
            className={`hs-dropdown-menu transition-[opacity,margin] duration ${isDropdownOpen ? 'opacity-100 block' : 'opacity-0 hidden'} min-w-60 bg-white shadow-md rounded-lg mt-2 divide-y divide-gray-200 absolute right-0 top-full z-50`}
            role="menu"
