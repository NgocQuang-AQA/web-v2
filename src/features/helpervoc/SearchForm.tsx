...
export default function SearchForm({ env, vocId, onChangeEnv, onChangeVocId, onSearch }: Props) {
  return (
    <form
    ...
    >
      ...
      <input value={vocId} onChange={(e) => onChangeVocId(e.target.value)} className="flex-1 rounded-xl border border-gray-200 px-3 py-2 text-sm" placeholder="Enter VOC ID" />
